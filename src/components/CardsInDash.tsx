...
import CategoryProgress from "./charts/CategoryChart";
import WeeklyProductivityChart from "./charts/WeeklyProductivityChart";
    ...
    <div className="w-full flex flex-col md:flex-row gap-4">
      <Card className="w-full md:w-1/4">
        <CardHeader className="flex flex-row justify-between items-center mb-3">
          <p className="text-xs text-[var(--text-secundary)] uppercase font-semibold">
            Resumo do Dia
          </p>
        ...
        <CardFooter className="">
          <Link
            href={"/tarefas"}
            className="w-full flex flex-row justify-between items-center gap-1.5 text-[var(--primary)] text-xs font-semibold"
          >
            Ver pendências
      ...
      <Card className="w-full md:w-1/4">
        ...
        <CardContent className="flex flex-row justify-between items-center">
          <div className="text-left">
            ...
            <p className="text-xs text-[var(--text-secundary)] mt-2">
              Hoje: 90min de foco total
            </p>
          </div>
          <div className="flex flex-col items-center justify-center">
            <button className="px-3 py-2 rounded-xl text-xs font-bold text-white bg-orange-500">
              Focar
            </button>
          </div>
        </CardContent>
...
export function MiddleCards() {
  return (
    <div className="w-full flex flex-col md:flex-row gap-4">
      <Card className="w-full md:w-3/5 p-6">
        <CardHeader className="flex flex-row justify-between items-center mb-3">
          <div className="flex flex-col gap-1.5">
            <p className="text-sm text-[var(--text)] font-semibold">
              Produtividade Semanal (Tarefas Realizadas)
            </p>
            <p className="text-xs text-[var(--text-secundary)] font-semibold">
              Média diária de 6.4 tarefas entregues
            </p>
          </div>

          <p className="text-xs font-semibold text-[var(--text-secundary)] bg-[var(--background)] px-2 py-1 rounded-xl">
            Últimos 7 dias
          </p>
        </CardHeader>
      ...
      <Card className="w-2/5 p-6">
        <CardHeader>
          <p className="text-sm text-[var(--text)] font-semibold mb-4">
    ...
    <div className="w-full flex flex-col md:flex-row gap-4">
      <Card className="w-full md:w-1/2 p-6">
        <CardHeader className="flex flex-row justify-between items-center mb-3">
          <div className="flex flex-col gap-1.5">
            <p className="text-sm text-[var(--text)] font-semibold">
              Agenda de Hoje (4 compromissos)
            </p>
            <p className="text-xs text-[var(--text-secundary)] font-semibold">
              Sua próxima reunião começa em breve
            </p>
          </div>
